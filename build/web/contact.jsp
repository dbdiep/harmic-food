<%-- 
    Document   : contact
    Created on : Jul 3, 2022, 9:46:18 PM
...
<body>
    ...
    <div class="product-area section-space-top-100 row">
        <div class="col-md-6">
            <img style="height: 400px; width: 600px;" src="admin/assets/img/map.PNG" alt="Logo">
        </div>
        <div class="col-md-6">
        <h3>Contact</h3>
        <div>
            <p>Address: Le Loi, Hue City, Viet Nam</p>
            <p>Phone: 3965410</p>
            <p>Email: harmicfoodshop@gmail.com</p>
        </div>
        </div>
    </div>
    <div class="footer">
